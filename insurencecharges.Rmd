...
We can se that the correlation coefficient between actual charges and the predicted charges is **0.8656935** with 95% Confidence Interval being **0.8321945, 0.8928960**. The prediction is fairly accurate as it predicts with close to 98% accuracy. 
